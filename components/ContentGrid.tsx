      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 p-12 w-full">
            <h3 className="text-white text-6xl font-black uppercase tracking-tighter mb-4 leading-none">DEEP SEA <br /> HORROR</h3>
            <p className="text-gray-300 max-w-xl mb-8 text-lg leading-relaxed font-medium">
        ...
        <div className="md:col-span-5 bg-blockster-green rounded-2xl p-12 flex flex-col justify-between group min-h-[480px] relative overflow-hidden reveal reveal-delay-2 shadow-block-green">
          ...
          <div className="relative z-10">
            <h3 className="text-white text-5xl font-black uppercase leading-none tracking-tighter mb-6">EXPLORE OUR WORLDS</h3>
        ...
        <div className="md:col-span-9 bg-white rounded-2xl p-10 flex flex-col md:flex-row gap-12 items-center reveal reveal-delay-2 shadow-block">
          <div className="flex-[0.6] text-left">
            <h3 className="text-5xl font-black uppercase tracking-tighter leading-none mb-6">BEHIND <br /> THE BLOCKS</h3>
