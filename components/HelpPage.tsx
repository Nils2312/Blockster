    ...
    <div className="pb-32 overflow-hidden">
      ...
      <div className={`transition-all duration-700 ${isReady ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12 pointer-events-none'}`}>
        <section className="max-w-7xl mx-auto px-6 md:px-12 pt-24 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          <div className="group bg-white p-8 md:p-12 rounded-2xl shadow-block flex flex-col justify-between min-h-[380px] relative overflow-hidden reveal tilt-l">
          ...
          <div className="group bg-blockster-green p-8 md:p-12 rounded-2xl shadow-block-green flex flex-col justify-between min-h-[380px] relative overflow-hidden reveal tilt-r">
        ...
        <section className="max-w-7xl mx-auto px-6 md:px-12 pt-32 md:pt-48">
          <div className="mb-16">
